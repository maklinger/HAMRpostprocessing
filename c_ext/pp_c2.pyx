...
def rdump_new(flag,RAD_M1, RESISTIVE, DOTRACER, TWO_T, P_NUM, DO_YE, DO_NUCLEAR, NEUTRINOS_M1, dir, dump, n_active_total, f1,f2,f3,nb,bs1,bs2,bs3, np.ndarray[np.float32_t, ndim=4, mode="c"]  rho, np.ndarray[np.float32_t, ndim=4, mode="c"]  index_tr1, np.ndarray[np.float32_t, ndim=4, mode="c"]  index_tr2, np.ndarray[np.float32_t, ndim=4, mode="c"]  ug, np.ndarray[np.float32_t, ndim=5, mode="c"]  uu, np.ndarray[np.float32_t, ndim=5, mode="c"]  B,np.ndarray[np.float32_t, ndim=5, mode="c"]  E,np.ndarray[np.float32_t, ndim=4, mode="c"]  E_rad, np.ndarray[np.float32_t, ndim=5, mode="c"]  uu_rad,np.ndarray[np.float32_t, ndim=4, mode="c"]  TE,np.ndarray[np.float32_t, ndim=4, mode="c"]  TI,np.ndarray[np.float32_t, ndim=4, mode="c"]  photon_number, np.ndarray[np.float32_t, ndim=4, mode="c"]  Ye, np.ndarray[np.float32_t, ndim=4, mode="c"]  X_alpha, np.ndarray[np.float32_t, ndim=4, mode="c"]  X_atm, np.ndarray[np.float32_t, ndim=4, mode="c"]  E_nu1,np.ndarray[np.float32_t, ndim=4, mode="c"]  E_nu2,np.ndarray[np.float32_t, ndim=4, mode="c"]  E_nu3, np.ndarray[np.float32_t, ndim=5, mode="c"]  uu_nu1,np.ndarray[np.float32_t, ndim=5, mode="c"]  uu_nu2,np.ndarray[np.float32_t, ndim=5, mode="c"]  uu_nu3,np.ndarray[np.float32_t, ndim=4, mode="c"]  nu_number1, np.ndarray[np.float32_t, ndim=4, mode="c"]  nu_number2, np.ndarray[np.float32_t, ndim=4, mode="c"]  nu_number3, np.ndarray[np.float32_t, ndim=6, mode="c"]  gcov, np.ndarray[np.float32_t, ndim=6, mode="c"]  gcon, axisym):
    py_byte_string = dir.encode('UTF-8')
    cdef char* c_string = py_byte_string
    kernel_rdump_new(flag, RAD_M1, RESISTIVE, DOTRACER, TWO_T, P_NUM, DO_YE, DO_NUCLEAR, NEUTRINOS_M1, c_string, dump, n_active_total, f1, f2, f3, nb, bs1, bs2, bs3, &rho[0,0,0,0], &index_tr1[0,0,0,0], &index_tr2[0,0,0,0], &ug[0,0,0,0], &uu[0,0,0,0,0], &B[0,0,0,0,0],&E[0,0,0,0,0],&E_rad[0,0,0,0],&uu_rad[0,0,0,0,0],&TE[0,0,0,0],&TI[0,0,0,0], &photon_number[0,0,0,0], &Ye[0,0,0,0], &X_alpha[0,0,0,0],&X_atm[0,0,0,0], &E_nu1[0,0,0,0],&E_nu2[0,0,0,0],&E_nu3[0,0,0,0],&uu_nu1[0,0,0,0,0],&uu_nu2[0,0,0,0,0],&uu_nu3[0,0,0,0,0],&nu_number1[0,0,0,0],&nu_number2[0,0,0,0],&nu_number3[0,0,0,0],&gcov[0,0,0,0,0,0],&gcon[0,0,0,0,0,0],axisym)

def rdump_griddata(flag, interpolate, RAD_M1, RESISTIVE, DOTRACER, TWO_T, P_NUM, DO_YE, DO_NUCLEAR, NEUTRINOS_M1, dir, dump, n_active_total, f1,f2,f3,nb,bs1,bs2,bs3, np.ndarray[np.float32_t, ndim=4, mode="c"]  rho, np.ndarray[np.float32_t, ndim=4, mode="c"]  index_tr1 ,np.ndarray[np.float32_t, ndim=4, mode="c"]  index_tr2, np.ndarray[np.float32_t, ndim=4, mode="c"]  ug, np.ndarray[np.float32_t, ndim=5, mode="c"]  uu, np.ndarray[np.float32_t, ndim=5, mode="c"]  B,np.ndarray[np.float32_t, ndim=5, mode="c"]  E,np.ndarray[np.float32_t, ndim=4, mode="c"]  E_rad, np.ndarray[np.float32_t, ndim=5, mode="c"]  uu_rad, np.ndarray[np.float32_t, ndim=4, mode="c"]  TE,np.ndarray[np.float32_t, ndim=4, mode="c"]  TI,np.ndarray[np.float32_t, ndim=4, mode="c"]  photon_number,np.ndarray[np.float32_t, ndim=4, mode="c"]  Ye, np.ndarray[np.float32_t, ndim=4, mode="c"]  X_alpha, np.ndarray[np.float32_t, ndim=4, mode="c"]  X_atm, np.ndarray[np.float32_t, ndim=4, mode="c"]  E_nu1,np.ndarray[np.float32_t, ndim=4, mode="c"]  E_nu2,np.ndarray[np.float32_t, ndim=4, mode="c"]  E_nu3, np.ndarray[np.float32_t, ndim=5, mode="c"]  uu_nu1,np.ndarray[np.float32_t, ndim=5, mode="c"]  uu_nu2,np.ndarray[np.float32_t, ndim=5, mode="c"]  uu_nu3,np.ndarray[np.float32_t, ndim=4, mode="c"]  nu_number1, np.ndarray[np.float32_t, ndim=4, mode="c"]  nu_number2, np.ndarray[np.float32_t, ndim=4, mode="c"]  nu_number3, np.ndarray[np.float32_t, ndim=6, mode="c"]  gcov, np.ndarray[np.float32_t, ndim=6, mode="c"]  gcon, axisym,np.ndarray[np.int32_t, ndim=1, mode="c"] n_ord,np.ndarray[np.int32_t, ndim=2, mode="c"] block, nb1,nb2,nb3,REF_1, REF_2, REF_3, ACTIVE_1, ACTIVE2, ACTIVE_3, export_raytracing,DISK_THICKNESS,a,gam, np.ndarray[np.float32_t, ndim=4, mode="c"] Rdot,np.ndarray[np.float32_t, ndim=4, mode="c"] bsq, np.ndarray[np.float32_t, ndim=4, mode="c"] r, startx1, startx2, fstartx3, _dx1, _dx2, _dx3, np.ndarray[np.float32_t, ndim=4, mode="c"]  x1,np.ndarray[np.float32_t, ndim=4, mode="c"]  x2, np.ndarray[np.float32_t, ndim=4, mode="c"]  x3, i_min, i_max, j_min, j_max, z_min, z_max):
    py_byte_string = dir.encode('UTF-8')
    cdef char* c_string = py_byte_string
    AMR_LEVEL1=  110
    AMR_LEVEL2 = 111
    ...
    AMR_COORD2_c = np.ascontiguousarray(block[:,AMR_COORD2], dtype=ctypes.c_int)
    AMR_COORD3_c = np.ascontiguousarray(block[:,AMR_COORD3], dtype=ctypes.c_int)
    kernel_rdump_griddata(flag, interpolate, RAD_M1, RESISTIVE, DOTRACER, TWO_T, P_NUM, DO_YE, DO_NUCLEAR, NEUTRINOS_M1, c_string, dump, n_active_total, f1, f2, f3, nb, bs1, bs2, bs3, &rho[0,0,0,0], &index_tr1[0,0,0,0], &index_tr2[0,0,0,0], &ug[0,0,0,0], &uu[0,0,0,0,0], &B[0,0,0,0,0], &E[0,0,0,0,0],&E_rad[0,0,0,0],&uu_rad[0,0,0,0,0],&TE[0,0,0,0],&TI[0,0,0,0],&photon_number[0,0,0,0],&Ye[0,0,0,0], &X_alpha[0,0,0,0],&X_atm[0,0,0,0], &E_nu1[0,0,0,0],&E_nu2[0,0,0,0],&E_nu3[0,0,0,0],&uu_nu1[0,0,0,0,0],&uu_nu2[0,0,0,0,0],&uu_nu3[0,0,0,0,0],&nu_number1[0,0,0,0],&nu_number2[0,0,0,0],&nu_number3[0,0,0,0],&gcov[0,0,0,0,0,0],&gcon[0,0,0,0,0,0],axisym, &n_ord_c[0],ACTIVE_1,ACTIVE2, ACTIVE_3, &AMR_LEVEL1_c[0], &AMR_LEVEL2_c[0], &AMR_LEVEL3_c[0], &AMR_COORD1_c[0], &AMR_COORD2_c[0], &AMR_COORD3_c[0], nb1, nb2, nb3, REF_1, REF_2, REF_3,export_raytracing, DISK_THICKNESS,a,gam, &Rdot[0,0,0,0],&bsq[0,0,0,0], &r[0,0,0,0], startx1, startx2, fstartx3, _dx1, _dx2, _dx3, &x1[0,0,0,0],&x2[0,0,0,0],&x3[0,0,0,0], i_min, i_max, j_min, j_max, z_min, z_max)
...
def rdump_write(flag, RAD_M1, RESISTIVE, DOTRACER, TWO_T, P_NUM,DO_YE, DO_NUCLEAR, NEUTRINOS_M1,dir, dump, n_active_total, f1,f2,f3,nb,bs1,bs2,bs3, np.ndarray[np.float32_t, ndim=4, mode="c"]  rho, np.ndarray[np.float32_t, ndim=4, mode="c"]  index_tr1,np.ndarray[np.float32_t, ndim=4, mode="c"]  index_tr2, np.ndarray[np.float32_t, ndim=4, mode="c"]  ug, np.ndarray[np.float32_t, ndim=5, mode="c"]  uu, np.ndarray[np.float32_t, ndim=5, mode="c"]  B, np.ndarray[np.float32_t, ndim=5, mode="c"]  E,np.ndarray[np.float32_t, ndim=4, mode="c"]  E_rad, np.ndarray[np.float32_t, ndim=5, mode="c"]  uu_rad,np.ndarray[np.float32_t, ndim=4, mode="c"]  TE,np.ndarray[np.float32_t, ndim=4, mode="c"]  TI,np.ndarray[np.float32_t, ndim=4, mode="c"]  photon_number,np.ndarray[np.float32_t, ndim=4, mode="c"]  Ye, np.ndarray[np.float32_t, ndim=4, mode="c"]  X_alpha, np.ndarray[np.float32_t, ndim=4, mode="c"]  X_atm, np.ndarray[np.float32_t, ndim=4, mode="c"]  E_nu1,np.ndarray[np.float32_t, ndim=4, mode="c"]  E_nu2,np.ndarray[np.float32_t, ndim=4, mode="c"]  E_nu3, np.ndarray[np.float32_t, ndim=5, mode="c"]  uu_nu1,np.ndarray[np.float32_t, ndim=5, mode="c"]  uu_nu2,np.ndarray[np.float32_t, ndim=5, mode="c"]  uu_nu3,np.ndarray[np.float32_t, ndim=4, mode="c"]  nu_number1, np.ndarray[np.float32_t, ndim=4, mode="c"]  nu_number2, np.ndarray[np.float32_t, ndim=4, mode="c"]  nu_number3, np.ndarray[np.float32_t, ndim=6, mode="c"]  gcov, np.ndarray[np.float32_t, ndim=6, mode="c"]  gcon, axisym):
    kernel_rdump_write(flag, RAD_M1, RESISTIVE, DOTRACER, TWO_T, P_NUM,DO_YE, DO_NUCLEAR, NEUTRINOS_M1, dir, dump, n_active_total, f1, f2, f3, nb, bs1, bs2, bs3, &rho[0,0,0,0], &index_tr1[0,0,0,0], &index_tr2[0,0,0,0], &ug[0,0,0,0], &uu[0,0,0,0,0], &B[0,0,0,0,0],&E[0,0,0,0,0],&E_rad[0,0,0,0],&uu_rad[0,0,0,0,0],&TE[0,0,0,0],&TI[0,0,0,0],&photon_number[0,0,0,0],&Ye[0,0,0,0], &X_alpha[0,0,0,0],&X_atm[0,0,0,0], &E_nu1[0,0,0,0],&E_nu2[0,0,0,0],&E_nu3[0,0,0,0],&uu_nu1[0,0,0,0,0],&uu_nu2[0,0,0,0,0],&uu_nu3[0,0,0,0,0],&nu_number1[0,0,0,0],&nu_number2[0,0,0,0],&nu_number3[0,0,0,0],&gcov[0,0,0,0,0,0],&gcon[0,0,0,0,0,0],axisym)
